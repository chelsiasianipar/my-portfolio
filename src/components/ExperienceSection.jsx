  ...
  const projects = [
    ...
    },
    {
      ...
      highlights: [
        ...
        "Executed automated regression tests for critical workflowss",
    ...
    /* Jika mau menonaktifkan (comment out) proyek lain, simpan sebagai blok komentar seperti ini:
    ,
    {
